...
public class PageUtil<T> {
	...
	public void setTotalRecord(long totalRecord) {
		...
		int totalPage = ((Long) totalRecord).intValue() % pageSize == 0 ? ((Long) totalRecord).intValue() / pageSize
				: ((Long) totalRecord).intValue() / pageSize + 1;
	...
	public String getLinks() {
		...
		sBuf.append("	}");
		sBuf.append("</script>");
		sBuf.append("<input type=\"hidden\" id=\"page.pageNo\" name=\"pageNo\" value=\"").append(curPageNo)
				.append("\">"); // 分页参数：当前页隐藏域
