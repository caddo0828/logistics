...
<head>
	...
	<script type="text/javascript">
	 $(function() {
		/*  $("#sa").click(function() {
			var name = document.getElementById("checkeName");
			$.ajax("${ctx}/sysadmin/moduleAction_serachName",{name:name},function(data){
					alert("fff");
					if(data.result==200) {
						//代表不存在同名数据，允许新增该模块
						formSubmit('moduleAction_insert','_self');this.blur();
						return true;
					}else {
						alert("模块名存在重复，请重新选择!");
						return false;
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" id="checkeName" name="name" value=""/></td>
	            <td class="columnTitle">层数：</td>
	            <td class="tableContent"><input type="text" name="layerNum" value=""/></td>
	        </tr>	
	        <tr>
	        	<td class="columnTitle">父模块名称：</td>
